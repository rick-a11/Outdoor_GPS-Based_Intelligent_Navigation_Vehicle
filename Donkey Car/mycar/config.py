...
STEERING_CHANNEL = 1       # PCA 9685 channel for steering control
STEERING_LEFT_PWM = 460    # pwm value for full left steering (use `donkey calibrate` to measure value for your car)
STEERING_RIGHT_PWM = 290   # pwm value for full right steering (use `donkey calibrate` to measure value for your car)
...
# PATH FOLLOWING
#
PATH_FILENAME = "/home/yk/mycar/donkeycar_1.csv" #/home/yk/mycar/record/1.csv  # the path will be saved to this filename as comma separated x,y values
...
PATH_MIN_DIST = 0.000005          # after travelling this distance (m), save a path point
...
PID_P = 12000                     # proportional mult for PID path follower
PID_I = 20.0                       # integral mult for PID path follower
PID_D =12000                        # differential mult for PID path follower
PID_THROTTLE = 0.40        # constant throttle value during path following
...
PID_D_DELTA = 1000                  # amount the inc/dec function will change the D value
PID_P_DELTA = 1000                  # amount the inc/dec function will change the P value
...
#
SAVE_PATH_BTN = "b_button"        # button to save path
LOAD_PATH_BTN = "a_button"             # button (re)load path
RESET_ORIGIN_BTN = "y_button"     # button to press to move car back to origin
ERASE_PATH_BTN = "x_button"     # button to erase path
TOGGLE_RECORDING_BTN = "options" # button to toggle recording mode
...
INC_PID_P_BTN = "left_shoulder"            # button to change PID 'P' constant by PID_P_DELTA
DEC_PID_P_BTN = "right_shoulder"           # button to change PID 'P' constant by -PID_P_DELTA
